    ...
    if (true) {
      (function () {
        ...
        var ReactSharedInternals =
          React11.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED;
  ...
  ((_a = class extends Subscribable {
    ...
    onUnsubscribe() {
      ...
      if (!this.hasListeners()) {
        (_a13 = __privateGet(this, _cleanup)) == null
          ? void 0
          : _a13.call(this);
    ...
    isFocused() {
      ...
      return (
        ((_a13 = globalThis.document) == null
          ? void 0
          : _a13.visibilityState) !== 'hidden'
      );
    }
  }),
...
var TimeoutManager =
  ((_a2 = class {
    ...
    setTimeoutProvider(provider) {
      if (true) {
        if (
          __privateGet(this, _providerCalled) &&
...
function dehydrateQuery(query, serializeData, shouldRedactErrors) {
  const dehydratePromise = () => {
    var _a13;
    const promise =
      (_a13 = query.promise) == null
        ? void 0
        : _a13.then(serializeData).catch((error) => {
...
function dehydrate(client, options = {}) {
  ...
  const filterMutation =
    ...
    ((_a13 = client.getDefaultOptions().dehydrate) == null
      ? void 0
      : _a13.shouldDehydrateMutation) ??
  ...
  const filterQuery =
    ...
    ((_b = client.getDefaultOptions().dehydrate) == null
      ? void 0
      : _b.shouldDehydrateQuery) ??
    defaultShouldDehydrateQuery;
  const shouldRedactErrors =
    options.shouldRedactErrors ??
    ((_c = client.getDefaultOptions().dehydrate) == null
      ? void 0
      : _c.shouldRedactErrors) ??
    defaultShouldRedactErrors;
  const serializeData =
    options.serializeData ??
    ((_d = client.getDefaultOptions().dehydrate) == null
      ? void 0
      : _d.serializeData) ??
...
function hydrate(client, dehydratedState, options) {
  ...
  const deserializeData =
    ((_a13 = options == null ? void 0 : options.defaultOptions) == null
      ? void 0
      : _a13.deserializeData) ??
    ((_b = client.getDefaultOptions().hydrate) == null
      ? void 0
      : _b.deserializeData) ??
    defaultTransformerFn;
  ...
  mutations.forEach(({ state, ...mutationOptions2 }) => {
    ...
    mutationCache.build(
      client,
      {
        ...((_a14 = client.getDefaultOptions().hydrate) == null
          ? void 0
          : _a14.mutations),
        ...((_b2 = options == null ? void 0 : options.defaultOptions) == null
          ? void 0
          : _b2.mutations),
        ...mutationOptions2,
      },
  ...
  queries.forEach(
    ({
      ...
      const existingQueryIsPending =
        (query == null ? void 0 : query.state.status) === 'pending';
      const existingQueryIsFetching =
        (query == null ? void 0 : query.state.fetchStatus) === 'fetching';
      if (query) {
        const hasNewerSyncData =
          syncData && // We only need this undefined check to handle older dehydration
        ...
        query = queryCache.build(
          client,
          {
            ...((_a14 = client.getDefaultOptions().hydrate) == null
              ? void 0
              : _a14.queries),
            ...((_b2 = options == null ? void 0 : options.defaultOptions) ==
            null
              ? void 0
              : _b2.queries),
            queryKey,
      ...
      if (
        promise && // If the data was synchronously available, there is no need to set up
        // a retryer and thus no reason to call fetch
        !syncData &&
        !existingQueryIsPending &&
        !existingQueryIsFetching && // Only hydrate if dehydration is newer than any existing data,
...
var OnlineManager =
  ((_a3 = class extends Subscribable {
    constructor() {
      super();
    ...
    onUnsubscribe() {
      var _a13;
      if (!this.hasListeners()) {
        (_a13 = __privateGet(this, _cleanup2)) == null
          ? void 0
          : _a13.call(this);
  ...
  const run = () => {
    ...
    Promise.resolve(promiseOrValue)
      ...
      .catch((error) => {
        ...
        failureCount++;
        (_a13 = config.onFail) == null
          ? void 0
          : _a13.call(config, failureCount, error);
        sleep(delay)
          .then(() => {
...
function infiniteQueryBehavior(pages) {
  return {
    onFetch: (context, query) => {
      ...
      const direction =
        (_c =
          (_b = (_a13 = context.fetchOptions) == null ? void 0 : _a13.meta) ==
          null
            ? void 0
            : _b.fetchMore) == null
          ? void 0
          : _c.direction;
      const oldPages =
        ((_d = context.state.data) == null ? void 0 : _d.pages) || [];
      const oldPageParams =
        ((_e = context.state.data) == null ? void 0 : _e.pageParams) || [];
      ...
      if (context.options.persister) {
        context.fetchFn = () => {
          var _a14, _b2;
          return (_b2 = (_a14 = context.options).persister) == null
            ? void 0
            : _b2.call(
                _a14,
                fetchFn,
...
function getPreviousPageParam(options, { pages, pageParams }) {
  var _a13;
  return pages.length > 0
    ? (_a13 = options.getPreviousPageParam) == null
      ? void 0
      : _a13.call(options, pages[0], pages, pageParams[0], pageParams)
    : void 0;
}
...
var _queryType,
  ...
  _Query_instances,
  isInitialPausedFetch_fn,
  dispatch_fn,
  _a5;
var Query =
  ((_a5 = class extends Removable {
    constructor(config) {
      super();
    ...
    get promise() {
      var _a13;
      return (_a13 = __privateGet(this, _retryer)) == null
        ? void 0
        : _a13.promise;
    }
    setOptions(options) {
    ...
    cancel(options) {
      var _a13, _b;
      const promise =
        (_a13 = __privateGet(this, _retryer)) == null ? void 0 : _a13.promise;
      ...
      if (this.observers.includes(observer)) {
        ...
        if (!this.observers.length) {
          if (__privateGet(this, _retryer)) {
            if (
              __privateGet(this, _abortSignalConsumed) ||
              __privateMethod(
                this,
                _Query_instances,
                isInitialPausedFetch_fn,
    ...
    async fetch(options, fetchOptions) {
      ...
      if (
        ...
        ((_a13 = __privateGet(this, _retryer)) == null
          ? void 0
          : _a13.status()) !== 'rejected'
      ) {
        if (
      ...
      const behavior =
        __privateGet(this, _queryType) === 'infinite'
      ...
      if (
        ...
        this.state.fetchMeta !==
          ((_b = context.fetchOptions) == null ? void 0 : _b.meta)
      ) {
        __privateMethod(this, _Query_instances, dispatch_fn).call(this, {
          type: 'fetch',
      ...
      try {
        ...
        this.setData(data);
        (_e = (_d = __privateGet(this, _cache).config).onSuccess) == null
          ? void 0
          : _e.call(_d, data, this);
        (_g = (_f = __privateGet(this, _cache).config).onSettled) == null
          ? void 0
          : _g.call(_f, data, this.state.error, this);
        return data;
      } catch (error) {
        ...
        (_i = (_h = __privateGet(this, _cache).config).onError) == null
          ? void 0
          : _i.call(_h, error, this);
        (_k = (_j = __privateGet(this, _cache).config).onSettled) == null
          ? void 0
          : _k.call(_j, this.state.data, error, this);
        throw error;
      } finally {
        this.scheduleGc();
      }
...
var _client2,
  ...
  _a6;
var QueryObserver =
  ((_a6 = class extends Subscribable {
        ...
        get: (target, key) => {
          ...
          if (key === 'promise') {
            ...
            if (
              ...
              __privateGet(this, _currentThenable).status === 'pending'
            ) {
    ...
    createResult(query, options) {
        ...
        if (
          ...
          placeholderData =
            typeof options.placeholderData === 'function'
              ? options.placeholderData(
                  (_a13 = __privateGet(this, _lastQueryWithDefinedData)) == null
                    ? void 0
                    : _a13.state.data,
      ...
      if (options.select && data !== void 0 && !skipSelect) {
        if (
          prevResult &&
          data === (prevResultState == null ? void 0 : prevResultState.data) &&
      ...
      if (this.options.experimental_prefetchInRender) {
        ...
        const isErrorWithoutData =
          nextResult.status === 'error' && !hasResultData;
...
var InfiniteQueryObserver = class extends QueryObserver {
  ...
  createResult(query, options) {
    ...
    const fetchDirection =
      (_b = (_a13 = state.fetchMeta) == null ? void 0 : _a13.fetchMore) == null
        ? void 0
        : _b.direction;
...
var Mutation =
  ((_a7 = class extends Removable {
    ...
    continue() {
      var _a13;
      return (
        ((_a13 = __privateGet(this, _retryer2)) == null
          ? void 0
          : _a13.continue()) ?? // continuing a mutation assumes that variables are set, mutation must have been dehydrated before
    ...
    async execute(variables) {
      ...
      try {
        if (restored) {
          ...
          const context = await ((_b = (_a13 = this.options).onMutate) == null
            ? void 0
            : _b.call(_a13, variables, mutationFnContext));
        ...
        await ((_d = (_c = __privateGet(this, _mutationCache).config)
          .onSuccess) == null
          ? void 0
          : _d.call(
              _c,
        ...
        await ((_f = (_e = this.options).onSuccess) == null
          ? void 0
          : _f.call(
              _e,
              data,
        ...
        await ((_h = (_g = __privateGet(this, _mutationCache).config)
          .onSettled) == null
          ? void 0
          : _h.call(
              _g,
        ...
        await ((_j = (_i = this.options).onSettled) == null
          ? void 0
          : _j.call(
              _i,
              data,
        ...
        try {
          await ((_l = (_k = __privateGet(this, _mutationCache).config)
            .onError) == null
            ? void 0
            : _l.call(
                _k,
        ...
        try {
          await ((_n = (_m = this.options).onError) == null
            ? void 0
            : _n.call(
                _m,
                error,
        ...
        try {
          await ((_p = (_o = __privateGet(this, _mutationCache).config)
            .onSettled) == null
            ? void 0
            : _p.call(
                _o,
        ...
        try {
          await ((_r = (_q = this.options).onSettled) == null
            ? void 0
            : _r.call(
                _q,
                void 0,
...
var MutationCache =
  ((_a8 = class extends Subscribable {
    constructor(config = {}) {
      super();
    ...
    runNext(mutation) {
      ...
      if (typeof scope === 'string') {
        const foundMutation =
          (_a13 = __privateGet(this, _scopes).get(scope)) == null
            ? void 0
            : _a13.find((m) => m !== mutation && m.state.isPaused);
        return (
...
var _client4,
  ...
  _currentMutation,
  _mutateOptions,
  _MutationObserver_instances,
  updateResult_fn,
  notify_fn2,
  _a9;
var MutationObserver =
  ((_a9 = class extends Subscribable {
    constructor(client, options) {
      super();
      ...
      this.setOptions(options);
      this.bindMethods();
      __privateMethod(this, _MutationObserver_instances, updateResult_fn).call(
        this,
      );
    }
    bindMethods() {
    ...
    setOptions(options) {
      var _a13;
      const prevOptions = this.options;
      this.options = __privateGet(this, _client4).defaultMutationOptions(
        options,
      );
      ...
      if (
        (prevOptions == null ? void 0 : prevOptions.mutationKey) &&
        this.options.mutationKey &&
        hashKey(prevOptions.mutationKey) !== hashKey(this.options.mutationKey)
      ) {
        this.reset();
      } else if (
        ((_a13 = __privateGet(this, _currentMutation)) == null
          ? void 0
          : _a13.state.status) === 'pending'
      ) {
    ...
    onMutationUpdate(action) {
      ...
      __privateMethod(this, _MutationObserver_instances, notify_fn2).call(
        this,
        action,
      );
    }
    ...
    mutate(variables, options) {
      ...
      __privateSet(
        ...
        __privateGet(this, _client4)
          .getMutationCache()
          .build(__privateGet(this, _client4), this.options),
      );
    ...
    notifyManager.batch(() => {
      ...
      if (__privateGet(this, _mutateOptions) && this.hasListeners()) {
        ...
        if ((action == null ? void 0 : action.type) === 'success') {
          try {
            (_b = (_a13 = __privateGet(this, _mutateOptions)).onSuccess) == null
              ? void 0
              : _b.call(_a13, action.data, variables, onMutateResult, context);
          } catch (e) {
            void Promise.reject(e);
          }
          try {
            (_d = (_c = __privateGet(this, _mutateOptions)).onSettled) == null
              ? void 0
              : _d.call(
                  _c,
                  action.data,
          ...
          try {
            (_f = (_e = __privateGet(this, _mutateOptions)).onError) == null
              ? void 0
              : _f.call(_e, action.error, variables, onMutateResult, context);
          } catch (e) {
            void Promise.reject(e);
          }
          try {
            (_h = (_g = __privateGet(this, _mutateOptions)).onSettled) == null
              ? void 0
              : _h.call(
                  _g,
                  void 0,
...
var _client5,
  ...
  _lastQueryHashes,
  _observerMatches,
  _QueriesObserver_instances,
  trackResult_fn,
  combineResult_fn,
  shouldSkipCombine_fn,
  findMatchingObservers_fn,
  onUpdate_fn,
  notify_fn3,
  _a10;
var QueriesObserver =
  ((_a10 = class extends Subscribable {
      ...
      if (this.listeners.size === 1) {
        __privateGet(this, _observers2).forEach((observer) => {
          observer.subscribe((result) => {
            __privateMethod(this, _QueriesObserver_instances, onUpdate_fn).call(
              this,
              observer,
              result,
            );
    ...
    setQueries(queries, options) {
      ...
      if (true) {
        const queryHashes = queries.map(
          (query) =>
            __privateGet(this, _client5).defaultQueryOptions(query).queryHash,
        );
      ...
      notifyManager.batch(() => {
        ...
        const newObserverMatches = __privateMethod(
          this,
          _QueriesObserver_instances,
          findMatchingObservers_fn,
        ).call(this, __privateGet(this, _queries));
          ...
          difference(newObservers, prevObservers).forEach((observer) => {
            observer.subscribe((result) => {
              __privateMethod(
                ...
                _QueriesObserver_instances,
                onUpdate_fn,
              ).call(this, observer, result);
            });
          });
        }
        __privateMethod(this, _QueriesObserver_instances, notify_fn3).call(
          this,
        );
      });
    }
    ...
    getQueries() {
      return __privateGet(this, _observers2).map((observer) =>
      ...
      return [
        ...
        (r) => {
          return __privateMethod(
            ...
            _QueriesObserver_instances,
            combineResult_fn,
          ).call(this, r ?? result, combine, queryHashes);
        },
        () => {
          return __privateMethod(
            this,
  ...
  (combineResult_fn = function (input, combine, queryHashes) {
    if (combine) {
      ...
      if (
        ...
        __privateGet(this, _result) !== __privateGet(this, _lastResult) ||
        queryHashesChanged ||
        combine !== __privateGet(this, _lastCombine)
      ) {
        ...
        __privateSet(
          this,
          _combinedResult,
          replaceEqualDeep(__privateGet(this, _combinedResult), combine(input)),
        );
      }
  ...
  (shouldSkipCombine_fn = function () {
    var _a13;
    return (
      ((_a13 = __privateGet(this, _options)) == null
        ? void 0
        : _a13.combine) !== void 0 &&
      __privateGet(this, _observers2).some((observer, index) => {
        var _a14;
        return (
          observer.options.suspense &&
          ((_a14 = __privateGet(this, _result)[index]) == null
            ? void 0
            : _a14.data) === void 0
        );
      })
  ...
  (findMatchingObservers_fn = function (queries) {
    ...
    queries.forEach((options) => {
      var _a13;
      const defaultedOptions = __privateGet(this, _client5).defaultQueryOptions(
        options,
      );
      const match =
        (_a13 = prevObserversMap.get(defaultedOptions.queryHash)) == null
          ? void 0
          : _a13.shift();
      const observer =
        match ??
        new QueryObserver(__privateGet(this, _client5), defaultedOptions);
      observers.push({
  ...
  (onUpdate_fn = function (observer, result) {
    ...
    if (index !== -1) {
      __privateSet(
        this,
        _result,
        replaceAt(__privateGet(this, _result), index, result),
      );
  ...
  (notify_fn3 = function () {
    var _a13;
    if (this.hasListeners()) {
      const newTracked = __privateMethod(
        this,
        _QueriesObserver_instances,
        trackResult_fn,
      ).call(
        ...
        __privateGet(this, _observerMatches),
      );
      const shouldSkipCombine = __privateMethod(
        this,
        _QueriesObserver_instances,
        shouldSkipCombine_fn,
      ).call(this);
...
var _queries2, _a11;
var QueryCache =
  ((_a11 = class extends Subscribable {
    constructor(config = {}) {
      super();
...
var QueryClient =
  ((_a12 = class {
    ...
    unmount() {
      ...
      (_a13 = __privateGet(this, _unsubscribeFocus)) == null
        ? void 0
        : _a13.call(this);
      __privateSet(this, _unsubscribeFocus, void 0);
      (_b = __privateGet(this, _unsubscribeOnline)) == null
        ? void 0
        : _b.call(this);
    ...
    getQueryData(queryKey) {
      ...
      return (_a13 = __privateGet(this, _queryCache).get(options.queryHash)) ==
        null
        ? void 0
        : _a13.state.data;
    }
    ...
    for await (const chunk of stream) {
      ...
      if (isReplaceRefetch) {
        ...
        context.client.setQueryData(context.queryKey, (prev) =>
          reducer(prev === void 0 ? initialValue : prev, chunk),
        );
      }
    }
...
var useQueryErrorResetBoundary = () =>
  React3.useContext(QueryErrorResetBoundaryContext);
...
var ensurePreventErrorBoundaryRetry = (options, errorResetBoundary, query) => {
  const throwOnError =
    (query == null ? void 0 : query.state.error) &&
...
function useQueries({ queries, ...options }, queryClient) {
  ...
  if (
    firstSingleResultWhichShouldThrow == null
      ? void 0
      : firstSingleResultWhichShouldThrow.error
  ) {
...
function useBaseQuery(options, Observer, queryClient) {
  ...
  (_b =
    (_a13 = client.getDefaultOptions().queries) == null
      ? void 0
      : _a13._experimental_beforeQuery) == null
    ? void 0
    : _b.call(_a13, defaultedOptions);
  ...
  (_d =
    (_c = client.getDefaultOptions().queries) == null
      ? void 0
      : _c._experimental_afterQuery) == null
    ? void 0
    : _d.call(_c, defaultedOptions, result);
  if (
        ...
        if (!existingQuery) {
          ...
          const hydrationIsNewer =
            ...
            (dehydratedQuery.promise &&
              ...
              dehydratedQuery.dehydratedAt !== void 0 &&
