...
// Matches Figma frame 40:484 ("F-13 / Desactivar — Dialog Desktop").
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 backdrop-blur-sm">
      <div className="w-full max-w-[400px] rounded-lg border border-border bg-surface px-8 py-7">
        ...
        <p className="mt-2.5 text-small text-muted">
          ¿Estás seguro de que deseas desactivar a {clientName}? No podrá
          recibir cobros hasta que sea reactivado.
        </p>
